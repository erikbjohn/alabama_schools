...
2. Merge in data such as graduation rates, etc. *Waiting for Finnegan's data work*
...
These do not need to be added to the spreadsheet yet but would be really useful to try and track down.
...
1. A page or so about own experience (schools/years/outcomes/general observations)
2. Overview of the HS report that is now missing. Basic ideas/insights etc.
...
Gather the raw school file to be in long rather than wide format. Here is a subset of the output.
